...
rs_d1("regid")="User a"&userid&"Consumption"&cjpay&""  
...
rs_d2("regid")="User two"&userid&"Consumption"&cjpay&""
...
rs_d3("regid")="User three"&userid&"Consumption"&cjpay&""
...
rs_d5("regid")="Users district"&userid&"Consumption"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="Users city"&userid&"Consumption"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="Users province"&userid&"Consumption"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="Large regional user"&userid&"Consumption"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.Write "<script language=javascript>alert('Congratulations on buying gold card successfully. . . !');location.href='searchg0701.asp'</script>"
%>