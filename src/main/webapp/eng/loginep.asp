  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="90%" height="54%" id="AutoNumber1">
    <tr>
      <td width="93%" height="100%">
		<form method="POST" action="chkloginep.asp" name="form">
			  <font size="3">
			  <div align="center"><b>A currency quiz rules</b><table border="0" width="75%" id="table1">
					<tr>
						<td><p align="left"><font size="2" face="宋体">First, there are four quiz results (single, double, large and small), the system every 10 minutes out of the results, guess you can get 1.9 times the amount bet awards, if bet "single" 100 a coin, lottery results "single" was to guess, entitled 190 a currency; If you bet the "big" 100 a currency, lottery results for "big" was to guess, entitled 190 a currency; and so on.</font><p align="left"><font face="宋体" size="2">Second, the bet per bet a minimum of 20 credits from.</font><p align="left"><font face="宋体" size="2">Third, the guessing game is not 100% winning, the bet is a matter of winning or losing coins are not revoked, the game is not gambling, please keep a good game mentality and capabilities.</font></td>
					</tr>
				</table>
				</div>
				<p align="center">
				...
				<p align="center">
                  ...
                  <table border="0" cellpadding="0" style="border:1px solid #008000; border-collapse: collapse" width="50%" id="AutoNumber4" height="112" bgcolor="#FFD7D7">
                    ...
                    <tr><td width="70%" height="40" align="center" colspan="2" bgcolor="#FFD7D7"><p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><font size="3"><span style="font-size: 11pt"><input type="submit" value="Consent rules " name="login" class="lkbtn"></span></font></td>
                    </tr>
                    </table>
                    </center>
              </div>
