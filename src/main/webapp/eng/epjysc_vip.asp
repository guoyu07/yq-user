...
<DIV class=box_title>EP Traded Market</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <form method="POST" action="epjysc_vipuser.asp" name="fomr">
			<table border="0" width="100%" id="table1">
				<tr>
				<td width="448"> <p align="center"><strong><font color="#000000" size="5" face="楷体">A currency trading market</font></strong></td>
...
sql="select * from txpay where payonoff = '尚未转账' and ep=0 order by pdid asc,jyid asc" 
rs.open sql,conn1,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"epjysc_vip.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
