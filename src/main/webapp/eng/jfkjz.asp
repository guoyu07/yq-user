...
　</p>
			<p align="center">
　</p>
			<p align="center"><font style="font-size: 30pt; font-weight: 700" color="#FFFF00">Deadline quiz betting, lottery system is ready!</font></p>
　</p>
			<p align="center">
　</p>
			<p align="center">
...
function update(num) {
if(num == secs) {
   window.location="jfjqks.asp";  //2.htm为到时跳转的页面URL
}
else {
 printnr = secs-num;
