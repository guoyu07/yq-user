...
if rs.eof and rs.bof then
   response.write "<script language='javascript'>"
   response.write "alert('The players do not exist, please check the input is correct!');"
...
rs_d1("regid")="Businesses a"&userid&"Gouka"&cjpay&""  
...
rs_d2("regid")="Merchant two"&userid&"GoukaGouka"&cjpay&""
...
rs_d3("regid")="Three businessmen"&userid&"Gouka"&cjpay&""
...
rs_d5("regid")="Area businesses"&userid&"Gouka"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="Local businesses"&userid&"Gouka"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="Merchant province"&userid&"Gouka"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="Large area businesses"&userid&"Gouka"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.Write "<script language=javascript>alert('Congratulations on the success of issuing bonus results have been updated. . . !');location.href='searchg0701.asp'</script>"
%>