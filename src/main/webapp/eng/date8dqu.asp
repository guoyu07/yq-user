...
<title>Showing the major area service center case - assessment index major areas, the province</title>
<SCRIPT>
<!--
...
<div align="center">
	...
	<tr>
	<td>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><b><a href="javascript:openwindow('datesheng.asp')" style="text-decoration: none"><span style="font-size: 11pt">National statistics</span></a><span style="font-size: 11pt">
	</span> </b>
	...
	<span style="font-size: 11pt">Today, a district in east<b><font color="#0000FF"><%=rs_sd0("down_sd0")+rs_zs0("down_zs0")+rs_sh0("down_sh0")%></font></b>shares(Including Shandong<b><font color="#800000"><%=rs_sd0("down_sd0")%></font></b>shares,Jiangsu<b><font color="#800000"><%=rs_zs0("down_zs0")%></font></b>shares,Shanghai<b><font color="#800000"><%=rs_sh0("down_sh0")%></font></b>shares)---<a href="javascript:openwindow('8dqu0.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, the Second District in east<b><font color="#0000FF"><%=rs_nf0("down_nf0")+rs_zz0("down_zz0")+rs_fz0("down_fz0")%></font></b>shares(Including Anhui<b><font color="#800000"><%=rs_nf0("down_nf0")%></font></b>shares,Zhejiang<b><font color="#800000"><%=rs_zz0("down_zz0")%></font></b>shares,Fujian<b><font color="#800000"><%=rs_fz0("down_fz0")%></font></b>shares)---<a href="javascript:openwindow('8dqu1.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today in southern China<b><font color="#0000FF"><%=rs_gd0("down_gd0")+rs_gx0("down_gx0")+rs_nn0("down_nn0")%></font></b>shares(The Guangdong<b><font color="#800000"><%=rs_gd0("down_gd0")%></font></b>shares,Guangxi<b><font color="#800000"><%=rs_gx0("down_gx0")%></font></b>shares,Hainan<b><font color="#800000"><%=rs_nn0("down_nn0")%></font></b>shares,Sichuan<b><font color="#800000"><%=rs_xc0("down_xc0")%></font></b>shares)---<a href="javascript:openwindow('8dqu2.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, the current central China<b><font color="#0000FF"><%=rs_hbs0("down_hbs0")+rs_hns0("down_hns0")+rs_hn0("down_hn0")+rs_zx0("down_zx0")%></font></b>shares(Which Hubei<b><font color="#800000"><%=rs_hbs0("down_hbs0")%></font></b>shares,Hunan<b><font color="#800000"><%=rs_hns0("down_hns0")%></font></b>shares,Henan<b><font color="#800000"><%=rs_hn0("down_hn0")%></font></b>shares,Jiangxi<b><font color="#800000"><%=rs_zx0("down_zx0")%></font></b>shares)---<a href="javascript:openwindow('8dqu3.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, the current North China<b><font color="#0000FF"><%=rs_bj0("down_bj0")+rs_tj0("down_tj0")+rs_hb0("down_hb0")+rs_sx0("down_sx0")+rs_nmg0("down_nmg0")%></font></b>shares(Which Beijing<b><font color="#800000"><%=rs_bj0("down_bj0")%></font></b>shares,Tianjin<b><font color="#800000"><%=rs_tj0("down_tj0")%></font></b>shares,Hebei<b><font color="#800000"><%=rs_hb0("down_hb0")%></font></b>shares,Shanxi<b><font color="#800000"><%=rs_sx0("down_sx0")%></font></b>shares,Inner Mongolia<b><font color="#800000"><%=rs_nmg0("down_nmg0")%></font></b>shares)---<a href="javascript:openwindow('8dqu4.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, the current Northwest<b><font color="#0000FF"><%=rs_ns0("down_ns0")+rs_sj0("down_sj0")+rs_qh0("down_qh0")+rs_sxs0("down_sxs0")+rs_js0("down_js0")%></font></b>shares(Which Ningxia<b><font color="#800000"><%=rs_ns0("down_ns0")%></font></b>shares,Xinjiang<b><font color="#800000"><%=rs_sj0("down_sj0")%></font></b>shares,Qinghai<b><font color="#800000"><%=rs_qh0("down_qh0")%></font></b>shares,Shanxi<b><font color="#800000"><%=rs_sxs0("down_sxs0")%></font></b>shares,Gansu<b><font color="#800000"><%=rs_js0("down_js0")%></font></b>shares)---<a href="javascript:openwindow('8dqu5.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, Southwest currently<b><font color="#0000FF"><%=rs_xc0("down_xc0")+rs_un0("down_un0")+rs_gz0("down_gz0")+rs_xz0("down_xz0")+rs_cq0("down_cq0")%></font></b>shares(Which Yunnan<b><font color="#800000"><%=rs_un0("down_un0")%></font></b>shares,Guizhou<b><font color="#800000"><%=rs_gz0("down_gz0")%></font></b>shares,Tibet<b><font color="#800000"><%=rs_xz0("down_xz0")%></font></b>shares,Chongqing<b><font color="#800000"><%=rs_cq0("down_cq0")%></font></b>shares)---<a href="javascript:openwindow('8dqu6.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, the Northeast region<b><font color="#0000FF"><%=rs_ln0("down_ln0")+rs_jl0("down_jl0")+rs_hlj0("down_hlj0")%></font></b>shares(Which Liaoning<b><font color="#800000"><%=rs_ln0("down_ln0")%></font></b>shares,Jilin<b><font color="#800000"><%=rs_jl0("down_jl0")%></font></b>shares,Heilongjiang<b><font color="#800000"><%=rs_hlj0("down_hlj0")%></font></b>shares)---<a href="javascript:openwindow('8dqu7.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">Today, Hong Kong, Macao and Taiwan regions currently<b><font color="#0000FF"><%=rs_tw0("down_tw0")+rs_sg0("down_sg0")+rs_om0("down_om0")%></font></b>shares(Of which Taiwan<b><font color="#800000"><%=rs_tw0("down_tw0")%></font></b>shares,Hong Kong<b><font color="#800000"><%=rs_sg0("down_sg0")%></font></b>shares,Macao<b><font color="#800000"><%=rs_om0("down_om0")%></font></b>shares)---<a href="javascript:openwindow('8dqu8.asp')" style="text-decoration: none">History</a></span></p>
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
	<span style="font-size: 11pt">
