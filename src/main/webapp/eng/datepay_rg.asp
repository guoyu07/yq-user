...
<html>
<title>Call a breakdown of currency changes</title>
...
<DIV class=box_title>Call a currency change out fine</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<font color="#000000" face="楷体" size="5"><strong>Call a currency change out fine</strong></font></td> 
  </tr> 
...
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then
       response.write "<p align='center'> Call recording not a currency, to refuel ah!</p>" 
   else 
