...
<%
rs("pay")=rs("pay")-jcpay
rs("vippay")=rs("vippay")-jcpay
rs("fhpay")=rs("fhpay")-jcpay
rs("txpay")=rs("txpay")+jcpay
rs("gmdate")=now()
rs.update
...
rs_d0("regid")="A currency purchase gold card balance"&cjpay&""
rs_d0("jc")=jcpay
rs_d0("pay")=rs("pay")
rs_d0("jydb")=rs("jydb")
rs_d0.update
...
rs_d1("regid")="one "&username&"Self-card purchase"&cjpay&""  
...
rs_d2("regid")="two "&username&"Self-card purchase"&cjpay&""
...
rs_d3("regid")="Three "&username&"Self-card purchase"&cjpay&""
...
rs_d5("regid")="Area "&username&"Self-card purchase"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="Local "&username&"Self-card purchase"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="Merchant "&username&"Self-card purchase"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="Large area "&username&"Self-card purchase"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.redirect"/0625fhk/pdfhk0102/jztojb5.asp?mj="&gmmj&"&lksl="&lksl&"&fk="&username&""
%>