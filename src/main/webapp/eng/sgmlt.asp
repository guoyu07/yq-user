...
if rs_my.eof and rs_my.bof or rs_my("sjb")=0 then
   response.write "<script language='javascript'>"
   response.write "alert('Not a dual-zone users, please check the input is correct or contact customer upgrades!');"
   response.write "history.go(-1);"
   response.write "</script>"
   response.end
end if
...
<DIV class=box_con style=" text-align:left">
	...
	<p align="left"><span style="font-size: 11pt; font-weight:700"><a href="sgmlt.asp?up=<%=username%>"><font color="#008000">Return to yourself:<%=username%></font></a></span></td>
	</tr>
	</table>
	</td>
	</tr>
