...
<html>
<title>Ask a breakdown of currency changes</title>
...
<DIV class=box_title>Sell out of a currency change out fine</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<font color="#000000" face="楷体" size="5"><strong>Sell out of a currency change out fine</strong></font></td> 
  </tr> 
...
sql="select * from datepay where username = '"&regid&"' and newbz=3 order by id desc" 
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then
       response.write "<p align='center'> No one currency to sell records, to refuel ah!</p>"
   else 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"datepay_mc.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
