...
rs_d0("regid")="To consumers"&lkid&"Fat Gold Card"&cjpay&""
rs_d0("jc")=jcpay
rs_d0("pay")=rs("pay")
rs_d0("jydb")=rs("jydb")
'rs_d0("bz")=2
...
rs_d1("regid")="Businesses a"&username&"Gouka"&cjpay&""  
...
rs_d2("regid")="Merchant two"&username&"Gouka"&cjpay&""
...
rs_d3("regid")="Three businessmen"&username&"Gouka"&cjpay&""
...
rs_d5("regid")="Area businesses"&lkid&"Gouka"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="Local businesses"&lkid&"Gouka"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="Merchant province"&lkid&"Gouka"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="Large area businesses"&lkid&"Gouka"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.redirect"/0625fhk/pdfhk0102/sjfk007.asp?lkid="&lkid&"&mj="&gmmj&"&lksl="&lksl&"&fk="&rs("username")&""
%>