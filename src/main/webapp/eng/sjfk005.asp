...
elseif rs("pay")<dlsy*1.5 then
   response.write"<script>alert('Note: Your one currency is not enough for this card, please recharge!');history.go(-1);</script>"
   response.end
end if
%>
<%
...
<p><font style="font-size: 20pt; font-weight: 700" color="#800000">Has received</font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF"><%=dlsy*1.5%>A currency</font><font style="font-size: 20pt; font-weight: 700" color="#800000">Cash</font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF">=</font><font style="font-size: 20pt; font-weight: 700" color="#008000"><%=dlsy/10%>Zhang</font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF">The nominal value of 10 gold card</font><font style="font-size: 20pt; font-weight: 700">The nominal value of the accumulated gold<%=dlsy%>A</font></p>
<p>　</p>
<p><a onClick="return confirm('Tip: Are you sure it?')" href="sjfk006.asp?lkid=<%=lkid%>&mj=<%=request("mj")%>&jbpay=<%=dlsy%>&lksl=<%=gmsl%>"><input type="button" value="OK receive" name="B1" onclick=disabled=true style="font-size: 24pt; color: #0000FF; font-weight: bold"></a></p>
<p>　</p>
