...
%>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="85" id="table1">
    <tr>
     <td width="100%" height="25"><p align="center"><p align="center"><strong><font color="#FF0000" size="5">Buy Information</font></strong><p align="center"></td> 
  </tr>
  <tr>
...
%><div align="center">    
          ...
          <tr> 
          <td width="200" align="center" height="30" bgcolor="#FFE1FF"><font color="#FF0000" size="2"><strong>RFQs</strong></font></td>
          ...
          <td align="center" width="238" height="32"><%if rs("mysl")>0 then%><a onClick="return confirm('Tip: Are you sure it?')" target="main" href="wymc.asp?id=<%=rs("id")%>&sl=<%=rs("mysl")%>"><span style="font-size: 11pt; font-weight: 700"><font color="#008000">I want to sell</font></span></a><%end if%></td>
          </tr>
          <% i=i+1 
