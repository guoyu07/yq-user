...
<table width="619" border="0" cellpadding="0" class="border" style="border-color:#C0C0C0; border-width: 0; " bordercolor="#111111" id="table4" height="70">
  ...
  <tr>
    <td align="center" valign="top" width="615" style="color: #304618; font-size: 12px" bordercolor="#669933"> 
      <form method="POST" align="center" action="glfk005.asp?lkid=<%=lkid%>" name="Form" onSubmit="return checkdate()">
      <div align="center">
  ...
  <TBODY>
	...
	<b>
      ...
      <TD width="304" bgColor=#ffffff style="color: #304618; font-size: 12px" align="left">  
              ...
              <select size="1" name="gmsl">
				<option value="0" selected>==Please select the number==</option>
    ...
    <TR class=content> 
      <TD width="213" bgColor=#ffffff align="left" style="color: #304618; font-size: 12px">
		　</TD>
      <TD width="304" bgColor=#ffffff style="color: #304618; font-size: 12px" align="left">  
    <b><INPUT class=normalButton type=submit value="Submit" name=submit2 style="font-size: 11pt"><font color="#FF6600" style="font-size: 12pt; font-weight: 700">&nbsp; </font><a href="javascript:history.back();" style="text-decoration: none"><font color="#FF6600" style="font-size: 12pt; font-weight: 700">Return to the previous step</font></a></TD>
    </TR>
  </TBODY>
</TABLE>
</div>
