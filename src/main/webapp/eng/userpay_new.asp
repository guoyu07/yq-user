...
return (allValid);
  ...
  if (Form.txpay.value><%=rs("fhpay")%>) {      alert("You can not publish more than you can sell the game gains <%=rs("fhpay")%> A currency Oh!");      return false;    }
...
<body bgcolor="#FFF3D0" text="#000000" leftmargin="0" topmargin="3" marginheight="0"><div align="center"><b>
     <p></p>
     <p></p>
	 <p><font color="#008000" face="Á¥Êé" style="font-size: 30pt">Publish a currency sell (ask now)</font></p>
	<table border="0" width="75%" id="table1" height="80" bgcolor="#FFEEEE">
	 <tr>
	 <td><b>Dear Players<font color="#FF0000"><%=rs("name")%></font>Hello! After you apply for release, to subscribe for one single currency in the direction you hit the post within two hours of receiving your account!</td>
	 </tr>
	 <tr>
	 <td>
		<p style="margin-top: 0; margin-bottom: 0">You currently can sell a currency as follows:<b><font color="#008000"><%=rs("fhpay")%></font></b> A currency</p>
		<p style="margin-top: 0; margin-bottom: 0" align="center"><b><font color="#808000">Here only one currency to sell the game proceeds,</font></b><a href="userpay_jjep.asp"><input type="submit" value="For sell a currency bonus - click here!" name="B1" style="font-size: 12pt; font-family: ËÎÌå; color: #0000FF"></a></td>
	 </tr>
	 </table>
	 <table width="75%" border="0" cellpadding="0" class="border" bgcolor="#800080">
    <tr>
    <td align="center" valign="top" bgcolor="#FFFFFF" width="935"><form method="POST" align="center" name="Form" onSubmit="return checkdate()" action="tgtxok_new.asp">
    ...
    <TR class=content> 
      <TD width="317" bgColor=#ffffff align="right" height="29"><font style="font-size: 10pt">Ask EP Quantity:</font></TD>
      <TD width="571" bgColor=#ffffff height="29"><font style="font-size: 9pt" color="#FF0000">
		...
		</select>**</font><font style="font-size: 9pt">The current portion of the proceeds to sell the game as follows:</font><font style="font-size: 9pt; font-weight:700" color="#FF0000"><%=rs("fhpay")%></font></TD>
    </TR>
    <TR class=content> 
  ...
  <p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><font style="font-size: 10pt" color="#800080">Second,</font><font size="2" color="#800080">A currency to sell less than 500 (including 500), the transaction fee is: 15%, higher than 500, compared with 10%.</font></p>
	</td>
	</tr>
	</table>
		<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
		<font size="5" color="#FF0000" face="¿¬Ìå_GB2312">A currency - Money Trading Rules</font></p>
		<font size="3">
