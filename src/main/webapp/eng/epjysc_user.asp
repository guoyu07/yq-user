  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center"><strong><font color="#000000" size="5" face="楷体">EP Traded Market</font></strong></td> 
  </tr> 
  <tr> 
...
sql="select * from txpay where payonoff = '尚未转账' and ep=0 and payusername='"&request("user")&"'" 
