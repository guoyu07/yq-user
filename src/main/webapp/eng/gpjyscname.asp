...
%>
<html>
<title>MARKET - Select User</title>
...
<DIV class=box_title>Traded Market</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<strong>
		<font color="#000000" size="6">Plot points Traded Market</font><font color="#000000" style="font-size: 20pt">（</font><font color="#008000" style="font-size: 20pt">All Information</font><font color="#000000" style="font-size: 20pt">）</font></strong><p align="center">
		　<p align="center">
<font size="4">
<b><font color="#0000FF">The current trading price is </font><font color="#FF0000"><%=rs1("jygj")%> </font></b></font><font color="#0000FF">System refreshes every 60 seconds </font><strong><font color="#000000" style="font-size: 20pt">（</font></strong><font face="黑体"><font color="#800000"><b><a href="gpjymc.asp" style="text-decoration: none; background-color:#FFFFFF"><font size="5" color="#800000">View sale</font></a></b></font><font color="#000000"><font size="5">&nbsp; </font> <a href="gpjymy.asp" style="text-decoration: none; font-weight:700; background-color:#FFFFFF"><font size="5" color="#FF0000">View Buy</font></a></font></font><strong><font color="#000000" style="font-size: 20pt">）</font></strong><p align="center">
　<p align="center"> </td> 
  </tr> 
...
%></p>
	<div align="center">    
          ...
          <td valign="middle" align="center" width="252"><%if rs("mcsl")>0 then%><b><a onClick="return confirm('Tip: Are you sure it?')" href="wymy.asp?id=<%=rs("id")%>&pay=<%=rs("jypay")%>"><font color="#FF0000" style="font-size: 11pt">I want to buy</font></a></b><%else%><a onClick="return confirm('Tip: Are you sure it?')" href="wymc.asp?id=<%=rs("id")%>&sl=<%=rs("mysl")%>"><span style="font-size: 11pt; font-weight: 700"><font color="#008000">I want to sell</font></span></a><%end if%></td>
          </tr>
          <% i=i+1 
