...
<html>
<title>Points out fine red dot changes</title>
...
<DIV class=box_title>Points out fine red dot changes</DIV>
<DIV class=box>
<DIV class=box_con style=" text-align:left">

  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"><p align="center"><font color="#000000" size="3"><strong>Points out fine red dot changes</strong></font></td> 
  </tr> 
  <tr> 
...
sql="select * from gcfh where userid = '"&regid&"' and lb=0 order by id desc"
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"gpbf.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%><div align="center">    
          ...
          <td width="133" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000"> <strong style="font-weight: 400">Increased bonus points</strong></font></td>
          <td width="152" align="center" height="28" bgcolor="#FFE1FF"><font color="#FF0000">Cumulative number of</font></td>
          <td width="178" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">Update Time</font></td>
          <td width="232" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">Remark</font></td>
          </tr>
        <%do while not rs.eof%>
          <tr> 
          <td height="27" width="158" align="center"><p><font color="#000000"><%=regid%></font></td>
          <td valign="middle" width="133" align="center"><p><font color="#000000"><%=rs("sygc")%></font></td>
