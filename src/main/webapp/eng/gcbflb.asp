...
<html>
<title>Each of the red out of thin</title>
...
<DIV class=box_title>Each of the red out of thin</DIV>
<DIV class=box>
<DIV class=box_con style=" text-align:left">

  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"><p align="center"><font color="#000000" size="3"><strong>Each of the red out of thin</strong></font></td> 
  </tr> 
  <tr> 
...
%><div align="center">    
          <table border="1" cellspacing="0" width="100%" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0" height="56">
            <tr> 
          <td width="158" align="center" height="28" bgcolor="#FFE1FF"><font face="Arial" color="#000000"><strong style="font-weight: 400">Username</strong></font></td>
          <td width="152" align="center" height="28" bgcolor="#FFE1FF"><b><font color="#008000">Company Shifa number</font></b></td>
          <td width="152" align="center" height="28" bgcolor="#FFE1FF"><font color="#FF0000">The number of individual participation points</font></td>
