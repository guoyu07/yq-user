...
<DIV class=box_title>The whole part of the red out fine</DIV>
<DIV class=box>
<DIV class=box_con style=" text-align:left">

  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"><p align="center"><font color="#000000" size="3"><strong>The whole part of the red out fine</strong></font></td> 
  </tr> 
  <tr> 
...
sql="select * from gcfh where userid = '"&regid&"' and lb=1 order by id desc" 
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"gcbftj.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%><div align="center">    
          <table border="1" cellspacing="0" width="100%" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0" height="56">
            <tr> 
          <td width="158" align="center" height="28" bgcolor="#FFE1FF"><font face="Arial" color="#000000"><strong style="font-weight: 400">User name</strong></font></td>
          <td width="152" align="center" height="28" bgcolor="#FFE1FF"><font color="#FF0000">Individual holding the number of points</font></td>
          <td width="143" align="center" height="28" bgcolor="#FFE1FF"><p><font face="Arial" color="#000000">Each point bonus</font></td>
          <td width="154" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">Current cumulative</font></td>
          <td width="163" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">All cumulative</font></td>
          <td width="178" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">Bonus time</font></td>
          <td width="232" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000">Remark</font></td>
          </tr>
        <%do while not rs.eof%>
          <tr> 
          <td height="29" width="158" align="center"><p><font color="#000000"><%=regid%></font></td>
          <td valign="middle" align="center" width="152"><font color="#FF0000"><%=rs("sygc")%></font></td>
