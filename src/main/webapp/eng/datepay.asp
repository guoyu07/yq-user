...
<html>
<title>A breakdown of currency changes</title>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<font color="#000000" face="楷体" size="5"><strong>A currency change out fine</strong></font></td> 
  </tr> 
...
sql="select * from datepay where username = '"&regid&"' order by id desc" 
