...
rs0("jcname")=trim(request("jcname"))
rs0("jcuserid")=trim(request("jcuserid"))
...
response.Write "<script language=javascript>alert('用户资料修改成功！');location.href='modifyg01user.asp?userid="&userid&"';</script>"
response.end
%>