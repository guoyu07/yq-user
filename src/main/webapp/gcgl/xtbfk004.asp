...
<table width="619" border="0" cellpadding="0" class="border" style="border-color:#C0C0C0; border-width: 0; " bordercolor="#111111" id="table4" height="70">
  ...
  <tr>
    <td align="center" valign="top" width="615" style="color: #304618; font-size: 12px" bordercolor="#669933"> 
      <form method="POST" align="center" action="xtbfk005.asp?lkid=<%=lkid%>" name="Form" onSubmit="return checkdate()">
      <div align="center">
  ...
  <TBODY>
    <TR class=content> 
      ...
      <TD width="304" bgColor=#ffffff style="color: #304618; font-size: 12px" align="left">
		<b><font size="2" color="#0000FF"><%if request("gmmj")=1 then %>10金币（15元/张）<%elseif request("gmmj")=5 then %>50金币（75元/张）<%elseif request("gmmj")=10 then %>100金币（150元/张）<%elseif request("gmmj")=30 then %>300金币（450元/张）<%elseif request("gmmj")=50 then %>500金币（750元/张）<%elseif request("gmmj")=100 then %>1000金币（1500元/张）<%end if%></font></b></TD>
    </TR>
    <tr>
	<b>
      <TD width="213" bgColor=#ffffff align="left" style="color: #304618; font-size: 12px">
		...
		<b>
		<font size="3">请选择要补发的数量：</font></b></TD>
      <TD width="304" bgColor=#ffffff style="color: #304618; font-size: 12px" align="left">  
