...
%>
<% 
sql_mq="select sum(paynum) as ljmq from txpay where payonoff = '尚未转账' and ep=0 " 
Set rs_mq= Server.CreateObject("ADODB.Recordset") 
rs_mq.open sql_mq,conn1,1,1
%>
<html>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"><p align="center"><strong>
		<font color="#000000" size="5" face="楷体_GB2312">EP 交 易 市 场（</font><font color="#FF00FF" size="5" face="楷体_GB2312"><%=rs_mq("ljmq")%></font><font color="#000000" size="5" face="楷体_GB2312">）</font></strong></td> 
  </tr> 
  <tr> 
...
sql="select * from txpay where payonoff = '尚未转账' and ep=0 order by payid asc" 
rs.open sql,conn1,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"epjysc_pdid.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%></font><div align="center">    
          ...
          <td width="121" align="center" height="23" bgcolor="#FBFAEC">
			<font size="2">排队ID</font></td>
        ...
        <%do while not rs.eof%>
          ...
          <td valign="middle" align="center" width="121"><font size="2"><%=rs("pdid")%></font></td>
