  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<font color="#000000" face="楷体" size="5"><strong>转账EP 变 化 明 细</strong></font></td> 
  </tr> 
...
sql="select * from datepay where newbz=6 order by id desc" 
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"datepay_6666666.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
