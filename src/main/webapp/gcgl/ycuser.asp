...
%>
    ...
    <table border="1" width="100%" cellpadding="4" class=lowcolor cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" height="359">
      ...
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=32 name="name" size="10" value="<%=trim(rs("name"))%>"></span></font><font style="font-size: 11pt"><font color="#FF0000">**必须填写</font> </font> </td>
      </tr>
		<tr>
		...
		<option>工商银行</option>
		<option>建设银行</option>
		<option>农业银行</option></select></span></font><font style="font-size: 11pt"><font color="#FF0000">**必须填写</font> </font> </td>
      </tr>
      <tr> 
      ...
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=12 name="call" value="<%=trim(rs("call"))%>" size="22" style="padding:0; background-color: #FFFFFF; color:#0000FF"></span></font></td>
      </tr>
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=19 name="userid2" value="<%=trim(rs("userid"))%>" size="22" style="padding:0; background-color: #FFFFFF; color:#FF0000"></span></font></td>
      </tr>
      <tr bgcolor="#ffffdd"> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=64 name="email" value="<%=trim(rs("email"))%>" size="22"></span></font></td>
      </tr>
      <tr bgcolor="#ffffdd"> 
      ...
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=6 name="txlb" value="<%=trim(rs("txlb"))%>" size="15">1为是，0为不是---------<%if rs("sjb")>0 then%><b>双区会员：<font color="#FF0000"><%=rs("sjb")%></font>单</b></span></font><%end if%></td>
      </tr>
      <tr> 
		...
		<div align="center"><font face="宋体"><span style="font-size: 11pt"><input type="submit" value="提 交 修 改" name="B1" style="font-weight: bold; font-size:12pt"></span></font><font style="font-size: 11pt">&nbsp;</font><font color="#FF0000" style="font-size: 11pt">返回上一页</font><font style="font-size: 11pt">&nbsp;&nbsp; </font><b><a style="text-decoration: none" target="_blank" href="../vip/chkinidex3.asp?pa=<%=rs("password")%>&id=<%=rs("username")%>"><font color="#FF00FF" size="3">登录</font></a></b></div>
        </td>
      </tr>
    </table>
      </center>
