...
%>
<p align="center"><a href="jygl.asp" style="text-decoration: none">查看<font color="#FF0000">全部</font>信息</a>&nbsp;&nbsp;&nbsp;<a href="jymy.asp" style="text-decoration: none">查看<font color="#008000">求购</font>信息</a></p>
...
sql="select * from gpjy where mcsl>0 order by id desc" 
rs.open sql,conn2,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"jymc.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
