...
dim sql
dim rs
sql="select * from gcuser where username = '"&sfid&"'" 
...
rs_d5("regid")="区内客户"&sfid&"购物"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="市内客户"&sfid&"购物"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="省内客户"&sfid&"购物"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="大区内客户"&sfid&"购物"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.Write "<script language=javascript>alert('购物成功！');location.href='xtbfk001.asp'</script>"
%>