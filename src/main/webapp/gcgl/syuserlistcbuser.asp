...
<div align="center">
  <table border="0" cellspacing="1" width="100%" bgcolor="#7bb5de" height="146">
    <tr>
      <td width="97%" height="26" background="/meme/images/admin_bg_1.gif"><p align="center"><font color="#000000" style="font-size: 14px"><strong>促 销 用 户 信 息 结 果</strong></font></td> 
  </tr>
  <tr> 
...
sql_serch="select * from gcuser where cbuser=1 order by id desc"
...
rs_serch.open sql_serch,conn2,1,1 
  if rs_serch.eof and rs_serch.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
           showpage totalput,MaxPerPage,"syuserlistcbuser.asp" 
            showContent 
            showpage totalput,MaxPerPage,"syuserlistcbuser.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
