...
%>
<%
response.Write "<script language=javascript>alert('2012年10月后双区会员[分红]成功！');location.replace('searchg0701.asp');</script>"
%>