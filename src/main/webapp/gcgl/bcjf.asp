...
%>
<form method="POST" action="jfsave.asp?bcid=<%=userid%>" name="form">
	<div align="center">
		<font color="#008000"><b><%=userid%></b></font><table border="0" width="30%" id="table1" cellspacing="3" height="68" cellpadding="2">
			<tr>
				...
				<p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><%=rs("jyg")%></b></font>+<input type="text" name="bcjf" size="10" value="0"></td>
			</tr>
			</table>
	</div>
