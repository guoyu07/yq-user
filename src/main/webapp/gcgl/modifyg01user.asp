...
%>
    ...
    <table border="1" width="100%" cellpadding="4" class=lowcolor cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" height="359">
      ...
      <tr bgcolor="#ffffdd"> 
        <td align="right" width="36%" height="29" style="color: #0000000; font-family: 宋体; font-size: 9pt; line-height: 18px" bgcolor="#D9E6FF"><font style="font-size: 11pt">用户名：</font></td>
        <td width="63%" align="left" height="29" style="color: #0000000; font-family: 宋体; font-size: 9pt; line-height: 18px" bgcolor="#D9E6FF"><font color="#FF0000" style="font-size: 11pt"><%=rs("username")%>&nbsp;&nbsp; </font><font style="font-size: 11pt">推荐人：</font><b><font color="#000080" style="font-size: 11pt"><%=rs("up")%></font></b></td>
      </tr>
      <tr> 
      ...
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt">
		<input type="text" maxlength=32 name="name" size="10" value="<%=trim(rs("name"))%>"></span></font><font style="font-size: 11pt"><font color="#FF0000">**必须填写</font> </font> </td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><select size="1" name="bank">
		<option selected><%=trim(rs("bank"))%></option>
		<option>工商银行</option>
		<option>建设银行</option>
		<option>农业银行</option>
		<option>中国银行</option>
		</select></span></font><font style="font-size: 11pt"><font color="#FF0000">**必须填写</font> </font> </td>
      </tr>
      <tr> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=32 name="card" size="22" value="<%=trim(rs("card"))%>"></span></font><font style="font-size: 11pt"> </font> </td>
      </tr>
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=12 name="call" value="<%=trim(rs("call"))%>" size="22" style="padding:0; background-color: #FFFFFF; color:#0000FF">&nbsp;<b>继承人：</b><input type="text" name="jcname" size="10" value="<%=trim(rs("jcname"))%>"></span></font></td>
      </tr>
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=19 name="userid2" value="<%=trim(rs("userid"))%>" size="22" style="padding:0; background-color: #FFFFFF; color:#FF0000">&nbsp;<b>身份证：</b><input type="text" name="jcuserid" size="22" value="<%=trim(rs("jcuserid"))%>"></span></font></td>
      </tr>
      <tr bgcolor="#ffffdd"> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt">
		<input type="text" maxlength=64 name="email" value="<%=trim(rs("email"))%>" size="22"></span></font></td>
      </tr>
      <tr bgcolor="#ffffdd"> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=12 name="QQ" value="<%=trim(rs("qq"))%>" size="22" style="background-color: #E1FFF3"></span></font><font style="font-size: 11pt"></font></td>
      </tr>
      <tr> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=64 name="address" value="<%=trim(rs("addsheng"))%><%=trim(rs("addshi"))%><%=trim(rs("addqu"))%>" size="30"></span></font><font style="font-size: 11pt"></font><font color="#FF0000" style="font-size: 11pt">**必须填写<a style="text-decoration: none" target="_blank" href="../adduser.asp?addid=<%=rs("username")%>">修改</a></font></td>
      </tr>
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" name="regtime" size="30" value="<%=trim(rs("regtime"))%>" ></span></font></td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=20 name="dldate" value="<%=trim(rs("dldate"))%>" size="30" readonly>&nbsp;</span><b><font style="font-size: 11pt"><a target="_blank" href="dluser.asp?dldiy=<%=rs("username")%>" style="text-decoration: none">管理设置</a></font></b></font></td>
      </tr>
		<tr>
      ...
      <tr bgcolor="#ffffdd"> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" name="cjtj" size="15" value="<%=trim(rs("cjtj"))%>" readonly>最近一次充值时间：<%=trim(rs("gmdate"))%></span></font></td>
      </tr>
      <tr bgcolor="#ffffdd"> 
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" name="cbpay" size="15" value="<%=trim(rs("cbpay"))%>"></span></font></td>
      </tr>
      <tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" name="pay" size="15" value="<%=trim(rs("pay"))%>" ></span></font></td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=6 name="txpay" value="<%=trim(rs("txpay"))%>" size="15" ></span></font></td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=6 name="payok" value="<%=trim(rs("payok"))%>" size="15"></span></font></td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=6 name="cxt" value="<%=trim(rs("cxt"))%>" size="15"></span></font></td>
      </tr>
		<tr>
        ...
        <td width="63%" align="left" style="border-right: 1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF"><font face="宋体"><span style="font-size: 11pt"><input type="text" maxlength=6 name="txbl" value="<%=trim(rs("txlb"))%>" size="15">1为是，0为不是---------<%if rs("sjb")>0 then%><b>双区会员：<font color="#FF0000"><%=rs("sjb")%></font>单</b></span></font><%end if%></td>
      </tr>
      <tr> 
        <td align="center" colspan="2" style="border-left:1px solid #C9D8AD; border-right:1px solid #C9D8AD; border-bottom:1px solid #C9D8AD; color:#0000000; font-family:宋体; font-size:9pt; line-height:18px" bgcolor="#D9E6FF" height="22"> 
          <div align="center"> 
            　</div>
			<div align="center"><font face="宋体"><span style="font-size: 11pt"><input type="submit" value="提 交 修 改" name="B1" style="font-weight: bold; font-size:12pt"></span></font><font style="font-size: 11pt">&nbsp;</font><font color="#FF0000" style="font-size: 11pt">返回上一页</font><font style="font-size: 11pt">&nbsp;&nbsp; </font><b><a style="text-decoration: none" target="_blank" href="../vip/chkin_new.asp?pa=<%=rs("password")%>&id=<%=rs("username")%>"><font color="#FF00FF" size="3">登录</font></a></b><font style="font-size: 11pt">&nbsp;</font><span style="font-size: 11pt"></font></span><font color="#FF0000" style="font-size: 11pt">&nbsp; </font><a href="searchg0701.asp"><font color="#FF0000" style="font-size: 11pt">返回搜索</font></a></div>
        </td>
      </tr>
    </table>
      </center>
...
<table border="1" width="100%" id="table1">
	<tr>
		<td align="center"><iframe name="I3" width="100%" height="200" border="0" frameborder="0" src="bcgc.asp?bcid=<%=userid%>"></iframe></td>
		<td align="center"><iframe name="I4" width="100%" height="200" border="0" frameborder="0" src="jzbdb.asp?jzid=<%=userid%>"></iframe></td>
		<td align="center"><iframe name="I5" width="100%" height="200" border="0" frameborder="0" src="syuser.asp?syid=<%=userid%>"></iframe></td>
	</tr>
</table>
<p></p>