  ...
  <table border="0" cellspacing="1" width="100%" bgcolor="#FFFFFF">
    <tr>
      <td width="100%" height="25"> 
		...
		<span style="font-size: 14px">昨</span></font><font color="#FF0000" style="font-size: 14px"> 
		天 正 式 会 员 信 息</font></strong>(点击会员名可修改会员资料)</td> 
  </tr> 
   
 
  <tr> 
      <td width="100%" bgcolor="#C3DAF9"><br>
        <% 
dim sql 
dim rs 
sql="select * from cfuser where DateDiff('d',date(),regtime)=-1 order by regtime desc" 
...
rs.open sql,conn1,1,1 
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
           showpage totalput,MaxPerPage,"date02.asp" 
            showContent 
            showpage totalput,MaxPerPage,"date02.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%><div align="center"><center>
            <table border="1" cellspacing="0" width="100%" bgcolor="#F6F6EC" style="border-collapse: collapse" cellpadding="0">
              <tr bgcolor="#7bb5de"> 
                <td width="78" align="center" height="28" bgcolor="#C3DAF9"> 
				<font face="Arial"><strong style="font-weight: 400">ID</strong></font></td>
                <td width="101" align="center" height="28" bgcolor="#C3DAF9"> 
				<strong style="font-weight: 400">用户名</strong></td>
                <td width="98" align="center" height="28" bgcolor="#C3DAF9"> 
				<strong style="font-weight: 400">姓名</strong></td>
                <td width="118" align="center" height="28" bgcolor="#C3DAF9"> 
                  <align="center"><div align="center"><font face="Arial">QQ</font></div>
                </td>
				<td width="198" align="center" height="28" bgcolor="#C3DAF9"> 
                  <div align="center"><font face="Arial">注册时间</font></div>
                </td>
				<td width="201" align="center" height="28" bgcolor="#C3DAF9"> 
                  <div align="center"><font face="Arial">购物时间</font></div>
                </td>
                <td width="191" align="center" height="28" bgcolor="#C3DAF9"> 
                  　推荐人</td>
              ...
              <tr bgcolor="#7bb5de"> 
                ...
                <td style="border-bottom: 1px solid #C9D8AD" bgcolor="#C3DAF9"> 
                  <p align="center"><a target="_blank" href="/member/up2.asp?up=<%=rs("username")%>"><%=rs("username")%></a></td>
                <td style="border-bottom: 1px solid #C9D8AD" bgcolor="#C3DAF9"> 
                ...
                <td align="center" style="border-bottom: 1px solid #C9D8AD" bgcolor="#C3DAF9"> 
                  ...
                  <div align="left"><font color="#FF0000"><%=rs("gwdate")%></font></div>
                                ...
                                <td align="center" style="border-bottom: 1px solid #C9D8AD" bgcolor="#C3DAF9"><font color="#0000FF"><%=rs("pay")%></font>元</td>
              </tr>
              <% i=i+1 
