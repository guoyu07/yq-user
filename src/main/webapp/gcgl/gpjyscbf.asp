	...
	<div align="center">
		<table border="1" width="60%" id="table1" bgcolor="#404020" bordercolor="#000000" height="60">
			...
			<tr>
				...
				<td align="center"><font color="#FFFFFF" face="宋体" size="2">
	...
	<div align="center">    
          <table border="1" cellspacing="0" width="100%" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0" height="64">
            <tr> 
              ...
              <td width="126" align="center" height="30" bgcolor="#FFE1FF"> 
				<p style="line-height: 150%; margin-top: 0; margin-bottom: 0"> 
				<font color="#000000" size="2" face="宋体"> <strong style="font-weight: 400">交易额</strong></font></td>
                
              <td width="149" align="center" height="30" bgcolor="#FFE1FF"> 
                <p style="line-height: 150%; margin-top: 0; margin-bottom: 0"> 
                <font color="#000000" size="2" face="宋体">挂牌时间</font></td>
                
              <td width="137" align="center" height="30" bgcolor="#FFE1FF"> 
                <p style="line-height: 150%; margin-top: 0; margin-bottom: 0"> 
                <font color="#000000" size="2" face="宋体">发布方</font></td>
                
              <td width="252" align="center" height="30" bgcolor="#FFE1FF"> 
                <p style="line-height: 150%; margin-top: 0; margin-bottom: 0"> 
                <b><font size="2" face="宋体">操作</font></b></td>
              </tr>
              <%do while not rs.eof%>
              <tr> 
                <td height="35" width="169" align="center"> 
                  <p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
					<font color="#000000" size="2" face="宋体"><%=rs("id")%></font></td>
                <td width="147" align="center" bgcolor="#FAF8E6"> 
                ...
                <td valign="middle" width="146" align="center"> 
                  <p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                ...
                <td valign="middle" align="center" width="105"><b>
                ...
                <td valign="middle" align="center" width="137">
				<font size="2" face="宋体"><%=rs("username")%></font></td>
                <td valign="middle" align="center" width="252">
				<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
				<font face="宋体"><font size="2"><%if rs("mcsl")>0 then%></font><b><a onClick="return confirm('提示：您确定了吗？')" href="wymy.asp?id=<%=rs("id")%>&pay=<%=rs("jypay")%>"><font color="#FF0000" size="2">我要买入</font></a></b><font size="2"><%else%></font><a onClick="return confirm('提示：您确定了吗？')" href="wymc.asp?id=<%=rs("id")%>&sl=<%=rs("mysl")%>"><span style="font-weight: 700"><font color="#008000" size="2">我要卖出</font></span></a><font size="2"><%end if%></font></font></td>
              </tr>
              <% i=i+1 
