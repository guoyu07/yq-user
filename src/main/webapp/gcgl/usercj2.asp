...
<div align="center">
	...
	<table border="0" width="26%" id="table1" cellspacing="1" height="196">
		<tr>
			...
			<td align="left"><font face="黑体" size="5"><font color="#800000"><%=user%></font> </font>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="145" height="47"><font face="黑体" size="5">充值方式：</font></td>
...
<p align="center">　</p>
<p align="center"><a onClick="return confirm('提示：您确定收到 <%=cjpay%> 元了吗？')" href="modigwly.asp?czy=<%=czy%>&cj=<%=cjpay%>&uid=<%=user%>&fs=<%=cjfs%>"><input type="button" value="确认无误" name="B1" onclick=disabled=true style="font-size: 24pt; color: #0000FF; font-weight: bold"></a></p>
<p align="center">　</p>
<p align="center"> 
