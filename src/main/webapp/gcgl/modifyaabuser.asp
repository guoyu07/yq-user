    ...
    　<table border="1" width="100%" cellpadding="4" class=lowcolor cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" height="359">
      ...
      <tr> 
       ...
       <div align="center"><font face="黑体"><b>
		...
		<font color="#FF00FF" size="3">登录</font></a></b><font size="3">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</font></font><font color="#FF0000" size="3">&nbsp;&nbsp; </font><a href="searchg0701.asp">
		<font color="#FF0000" size="3">返回搜索</font></a><font color="#FF0000" size="3">&nbsp;&nbsp;&nbsp; </font>
		<b><font size="3">&nbsp;&nbsp;&nbsp;</font><a href="usercj.asp?id=<%=rs("username")%>" style="text-decoration: none"><font color="#000000" size="3">充值</font></a></b></font></div>
        </td>
      </tr>
    </table>
      </center>
...
<iframe name="I1" width="100%" height="200" border="0" frameborder="0" src="bcgp.asp?bcid=<%=userid%>"></iframe>
</p>
<p style="line-height: 100%; margin-top: 0; margin-bottom: 0">
<iframe name="I2" width="100%" height="200" border="0" frameborder="0" src="bcjb.asp?bcid=<%=userid%>">
</iframe></p>
<p style="line-height: 100%; margin-top: 0; margin-bottom: 0">
<iframe name="I3" width="100%" height="200" border="0" frameborder="0" src="bcjf.asp?bcid=<%=userid%>">
</iframe></p>
