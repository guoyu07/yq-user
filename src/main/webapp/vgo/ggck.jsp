...
<table border="0" width="100%" id="table1" cellspacing="1">
	<tr>
		<td>　</td>
		<td width="468" align="center"><c:if test="${dgag.bz!=''}">${dgag.bz}</c:if><c:if test="${dgag.bz==''}">积分游戏大平台</c:if></td>
		<td width="27">　</td>
	</tr>
	<tr>
		<td>　</td>
...
<p align="center"><a href="gg" style="text-decoration: none">返回公告</a></p>
