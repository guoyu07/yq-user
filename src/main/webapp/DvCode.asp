<%
Rem 动网论坛的验证码程序
Rem 这个程序真是不错，原作者自己实现的矢量图像变化
Rem 使用时，请到35行更改 CodeSessionName 为实际的session名称

Rem 2006-3-9
Rem NetDust 改了几个小地方
Rem 1、修正了一个可能除0的错误
Rem 2、字符的位置和实际宽、高加入了随机量
...
Const nBlankNoisyDotOdds = 0.03 ' 空白处噪点率
Const nColorNoisyDotOdds = 0.03 ' 有色处噪点率
Const nCharCount = 4						' 产生的字符个数
Const nPixelWidth = 40					' 单个字符位图的宽度
Const nPixelHeight = 40			 	  ' 单个字符位图的高度
