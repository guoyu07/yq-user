...
<div align="center">
	...
	<table border="0" width="75%" id="table1" height="120" cellspacing="1">
		<tr>
			<td>
			<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">消费编号是：<b><font color="#0000FF">${id}</font></b>&nbsp; 登录密码为：<b><font color="#FF0000">${pdpa}</font></b>&nbsp; 防伪编号为：<font color="#008000"><b>${fwid}&nbsp; </b></font>金币面值：<b>${ejbk.bf2}0</b></p>
		...
		<p><a href="gmjh?jh=${id}" style="text-decoration: none; font-weight: 700"><font size="4" color="#FF0000">点击返回</font></a></p>
	<p>　</div>