...
'if request.cookies("lkuserid")="" then
   ...
   'response.write "window.location.replace('/vip/datepay.asp');"
...
if rs("lksl")=0 or rs("lksl")<0 then
   response.Write "<script language=javascript>alert('电子卡发放及业绩更新成功！');location.href='/vip/datepay.asp'</script>"
   response.end
end if
%>
<%
