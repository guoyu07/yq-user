...
if rs("lksl")=0 or rs("lksl")<0 then
   response.Write "<script language=javascript>alert('电子卡发放及业绩更新成功！');location.href='/gcgl/xtbfk001.asp'</script>"
   response.end
end if
%>
<%
