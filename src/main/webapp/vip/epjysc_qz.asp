...
sql="select * from txpay where payonoff = '尚未转账' and ep=0 and vipname='15880805512' order by pdid asc,payid asc" 
rs.open sql,conn1,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"epjysc_qz.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%><div align="center">    
          <table border="1" cellspacing="0" width="100%" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0">
            <tr> 
          <td width="136" align="center" height="23" bgcolor="#FBFAEC"><b>流水号</b></td>
          <td width="126" align="center" height="23" bgcolor="#FBFAEC"><font face="Arial" color="#000000"><strong style="font-weight: 400">卖出方</strong></font></td>
          <td width="100" align="center" height="23" bgcolor="#FBFAEC"><b><font color="#FF00FF">信用星</font></b></td>
          <td width="137" align="center" height="23" bgcolor="#FBFAEC"><font color="#FF0000">求现金额</font></td>
          <td width="143" align="center" height="23" bgcolor="#FBFAEC">时间</td>
          <td width="169" align="center" height="23" bgcolor="#FBFAEC"><font color="#000000">认购后可换一币</font></td>
          <td width="151" align="center" height="23" bgcolor="#FBFAEC"><b><font color="#008000">认购后可获利</font></b></td>
          <td width="178" align="center" height="23" bgcolor="#FBFAEC">交易状态</td>
          <td width="160" align="center" height="23" bgcolor="#FBFAEC">操作</td>
          </tr>
        <%do while not rs.eof%>
          <tr> 
          ...
          <td valign="middle" align="center" width="178"><%if rs("payusername")=username then%><b><a onClick="return confirm('提示：您确定了吗？')" href="qxepmc.asp?qx=<%=rs("payid")%>"><font color="#FF0000">撤销卖出</font></a></b><%else%>等待认购中。。。<%end if%></td>
          <td valign="middle" align="center" width="160"><a onClick="return confirm('提示：对方使用的收款方式是“<%=rs("paybank")%>”您确定认购了吗？')" href="epmy.asp?ep=<%=rs("payid")%>"><font color="#FF0000" size="2">我要认购</font></a></td>
          </tr>
          <% i=i+1 
