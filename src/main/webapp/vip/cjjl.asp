...
<div align="center">
  ...
  <tr> 
	...
	<b><span style="font-size: 11pt">代理/商家<font color="#FF0000"><%=request("dl")%></font>历史充值记录</span></b><span style="font-size: 11pt"><% 
dim sql 
dim rs 
Set rs= Server.CreateObject("ADODB.Recordset")
sql="select * from datepay where username ='"&request("cj")&"'and regid="充值&" order by id desc" 
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then 
       response.write "<p align='center'>还没有历史充值记录！</p>" 
   else
