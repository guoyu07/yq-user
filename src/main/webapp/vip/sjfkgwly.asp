...
rs_d1("regid")="商家一"&userid&"购卡"&cjpay&""  
...
rs_d2("regid")="商家二"&userid&"购卡"&cjpay&""
...
rs_d3("regid")="商家三"&userid&"购卡"&cjpay&""
...
rs_d5("regid")="区内商家"&userid&"购卡"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="市内商家"&userid&"购卡"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="省内商家"&userid&"购卡"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="大区内商家"&userid&"购卡"&cjpay&""
rs_d8.update
end if
%>
<%
response.cookies("lsyh")=""
response.Write "<script language=javascript>alert('恭喜发卡成功，奖金业绩已更新。。。！');location.href='searchg0701.asp'</script>"
%>