...
<DIV class=box_con style=" text-align:left">
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="80">
    <tr>
      <td width="100%" height="25"><p align="center"><strong><font color="#000000" size="6">积 分 交 易 市 场</font></strong><font size="4"><b><font color="#0000FF">当前交易价是 </font><font color="#FF0000"><%if rs1("jygj")<1 then%>0<%=rs1("jygj")%><%else%><%=rs1("jygj")%><%end if%></font></b></font><p align="center">
　<p align="center"> </td> 
  </tr>
  <tr>
	...
	<div align="center">
		<table border="1" width="85%" id="table1" bgcolor="#404020" bordercolor="#000000" height="60">
			<tr>
				<td align="center" width="160" bgcolor="#FFFFFF" rowspan="2"><font color="#800000" face="黑体"><b><a href="mcsl.asp" style="text-decoration: none; background-color:#FFFFFF"><font color="#800000" style="font-size: 16pt">发布卖出</font></a></b></font></td>
				...
				<td align="center" width="160" bgcolor="#FFFFFF" rowspan="2"><font color="#000000" face="黑体"> <a href="mysl.asp" style="text-decoration: none; font-weight:700; background-color:#FFFFFF"><font color="#FF0000" style="font-size: 16pt">发布买入</font></a></font></td>
			</tr>
			<tr>
