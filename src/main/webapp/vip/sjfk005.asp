...
<p>　</p>
<p><a onClick="return confirm('提示：您确定了吗？')" href="sjfk006.asp?lkid=<%=lkid%>&mj=<%=request("mj")%>&jbpay=<%=dlsy%>&lksl=<%=gmsl%>"><input type="button" value="确定收到" name="B1" onclick=disabled=true style="font-size: 24pt; color: #0000FF; font-weight: bold"></a></p>
<p>　</p>
