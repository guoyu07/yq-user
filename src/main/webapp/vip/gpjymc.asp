...
%>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="85" id="table1">
    <tr>
     <td width="100%" height="25"><p align="center"><p align="center"><strong><font color="#008000" size="5">出售信息</font></strong><p align="center"></td> 
  </tr>
  <tr>
...
Set rs = conn2.execute(sql)
  if rs.eof and rs.bof then 
       response.write "<p align='center'>暂无出售记录</p>" 
   else 
...
%><div align="center">    
          ...
          <tr> 
          <td width="200" align="center" height="30" bgcolor="#FFE1FF"><font color="#000000" size="2"><strong>出售数量</strong></font></td>
          ...
          <td align="center" width="238" height="32"><%if rs("mcsl")>0 then%><b><a onClick="return confirm('提示：您确定了吗？')" target="main" href="wymy.asp?id=<%=rs("id")%>&pay=<%=rs("jypay")%>"><font color="#FF0000" style="font-size: 11pt">我要买入</font></a></b><%end if%></td>
          </tr>
          <% i=i+1 
