...
elseif rs("pay")<jcpay then
   response.write"<script>alert('注意：您的一币不够本次发卡，请充值！');history.go(-1);</script>"
   response.end  
end if
%>
<%
...
rs_d1("regid")="商家一"&username&"自助购卡"&cjpay&""  
...
rs_d2("regid")="商家二"&username&"自助购卡"&cjpay&""
...
rs_d3("regid")="商家三"&username&"自助购卡"&cjpay&""
...
rs_d5("regid")="区内商家"&username&"自助购卡"&cjpay&""
rs_d5.update
end if
%>
<%
...
rs_d6("regid")="市内商家"&username&"自助购卡"&cjpay&""
rs_d6.update
end if
%>
<%
...
rs_d7("regid")="省内商家"&username&"自助购卡"&cjpay&""
rs_d7.update
end if
%>
<%
...
rs_d8("regid")="大区内商家"&username&"自助购卡"&cjpay&""
rs_d8.update
end if
%>
<%
