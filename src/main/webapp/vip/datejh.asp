...
%><body bgcolor="#F5F5F1"><p align="center"><strong>
			<font color="#000000" style="font-size: 12pt">您搜索的是</font><font color="#FF0000" style="font-size: 12pt"><%=addsheng%><%if addshi<>"0" then%><%=addshi%><%if addqu<>"0" then%><%=addqu%><%if addzhen<>"0" then%><%=addzhen%><%end if%><%end if%><%end if%></font><font color="#008000"><%=jzt%></font>激活<font color="#0000FF" style="font-size: 12pt"><%=rs_om0("down_om0")%></font><font color="#000000" style="font-size: 12pt">股权</font></strong>