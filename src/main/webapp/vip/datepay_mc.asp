...
<DIV class=box_title>卖 出 一 币 变 化 明 细</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<font color="#000000" face="楷体" size="5"><strong>卖 出 一 币 变 化 明 细</strong></font></td> 
  </tr> 
...
rs.open sql,conn9,1,1
  if rs.eof and rs.bof then
       response.write "<p align='center'> 还没一币卖出记录，要加油啊！</p>"
   else 
