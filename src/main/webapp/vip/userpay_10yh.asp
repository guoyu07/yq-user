...
return (allValid);
  ...
  if (Form.txpay.value><%=rs("pay")%>) {      alert("您的发布不能大于您可卖的 <%=rs("pay")%> 一币哦!");      return false;    }
...
<body bgcolor="#FFF3D0" text="#000000" leftmargin="0" topmargin="3" marginheight="0"><div align="center"><b>
	...
	<table border="0" width="75%" id="table1" height="58" bgcolor="#FFEEEE">
	 ...
	 <tr>
	 <td>您当前可卖一币为：<b><font color="#008000"><%if rs("pay")<1 then%>0<%=rs("pay")%><%else%><%=rs("pay")%><%end if%></font></b> 一币</td>
	 </tr>
	 </table>
    ...
    <TR class=content> 
      ...
      <TD width="571" bgColor=#ffffff height="33"><font style="font-size: 9pt" color="#FF0000">
		...
		</select> **</font><font style="font-size: 9pt">当前可卖一币为：</font><font style="font-size: 9pt; " color="#FF0000"><%=rs("pay")%></font></TD>
    </TR>
    <TR class=content> 
