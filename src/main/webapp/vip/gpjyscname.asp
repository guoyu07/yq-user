...
<DIV class=box_title>交 易 市 场</DIV>
<DIV class=box>
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"> 
        <p align="center">
		<strong>
		<font color="#000000" size="6">积 分 交 易 市 场</font><font color="#000000" style="font-size: 20pt">（</font><font color="#008000" style="font-size: 20pt">全部信息</font><font color="#000000" style="font-size: 20pt">）</font></strong><p align="center">
		　<p align="center">
<font size="4">
<b><font color="#0000FF">当前交易价是 </font><font color="#FF0000"><%=rs1("jygj")%> </font></b></font><font color="#0000FF">系统每60秒刷新一次 </font><strong><font color="#000000" style="font-size: 20pt">（</font></strong><font face="黑体"><font color="#800000"><b><a href="gpjymc.asp" style="text-decoration: none; background-color:#FFFFFF"><font size="5" color="#800000">查看出售</font></a></b></font><font color="#000000"><font size="5">&nbsp; </font> <a href="gpjymy.asp" style="text-decoration: none; font-weight:700; background-color:#FFFFFF"><font size="5" color="#FF0000">查看求购</font></a></font></font><strong><font color="#000000" style="font-size: 20pt">）</font></strong><p align="center">
　<p align="center"> </td> 
  </tr> 
...
sql="select * from gpjy where jy=0 and username='"&request("fb")&"' order by pay,id " 
rs.open sql,conn2,1,1
  if rs.eof and rs.bof then 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
                       showContent 
            showpage totalput,MaxPerPage,"gpjyscname.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%></p>
	<div align="center">    
          ...
          <td valign="middle" align="center" width="252"><%if rs("mcsl")>0 then%><b><a onClick="return confirm('提示：您确定了吗？')" href="wymy.asp?id=<%=rs("id")%>&pay=<%=rs("jypay")%>"><font color="#FF0000" style="font-size: 11pt">我要买入</font></a></b><%else%><a onClick="return confirm('提示：您确定了吗？')" href="wymc.asp?id=<%=rs("id")%>&sl=<%=rs("mysl")%>"><span style="font-size: 11pt; font-weight: 700"><font color="#008000">我要卖给</font></span></a><%end if%></td>
          </tr>
          <% i=i+1 
