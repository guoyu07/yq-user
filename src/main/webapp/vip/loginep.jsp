...
<form method="POST" action="" name="Form" id="Form" onSubmit="return false">
			  ...
			  <div align="center"><b>一币竞猜规则</b><table border="0" width="75%" id="table1">
					<tr>
						<td><p align="left"><font size="2" face="宋体">一、竞猜共有四种结果（单、双、大、小），系统每10分钟开出一次结果，猜中则可以获得投注额的1.9倍奖励，如果投注“单”100一币，开奖结果为“单”则为猜中，可获190一币；如果投注“大”100一币，开奖结果为“大”则为猜中，可获190一币；以此类推。</font><p align="left"><font face="宋体" size="2">二、投注每注最低为20一币起。</font><p align="left"><font face="宋体" size="2">三、竞猜游戏中没有100%的中奖，所投注的一币不管输赢，均无法撤销，本游戏不是赌博，请保持良好的游戏心态，量力而行。</font></td>
					</tr>
				</table>
				</div>
				<p align="center">
				...
				<p align="center">
                  ...
                  <table border="0" cellpadding="0" style="border:1px solid #008000; border-collapse: collapse" width="50%" id="AutoNumber4" height="112" bgcolor="#FFD7D7">
                    ...
                    <tr><td width="70%" height="40" align="center" colspan="2" bgcolor="#FFD7D7"><p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><font size="3"><span style="font-size: 11pt"><input type="submit" value="同意规则 " name="login" class="lkbtn" onClick="checkdate();"></span></font></td>
                    </tr>
                    </table>
                    </center>
              </div>
