...
%><div align="center">    
          ...
          <td width="192" align="center" height="23" bgcolor="#FBFAEC">时间</td>
          <td width="114" align="center" height="23" bgcolor="#FBFAEC"><font color="#000000">认购后可换一币</font></td>
          <td width="144" align="center" height="23" bgcolor="#FBFAEC"><b><font color="#008000">认购后可获利</font></b></td>
          <td width="171" align="center" height="23" bgcolor="#FBFAEC">交易状态</td>
          </tr>
        <%do while not rs.eof%>
          <tr> 
          ...
          <td valign="middle" align="center" width="171"><%if rs("payusername")=username then%><b><a onClick="return confirm('提示：您确定了吗？')" href="qxepmc.asp?qx=<%=rs("payid")%>"><font color="#FF0000">撤销卖出</font></a></b><%else%>等待认购中。。。<%end if%></td>
          </tr>
          <% i=i+1 
