  ...
  if rs_serch.eof and rs_serch.bof then 
   ...
   pa=rs_serch("password") 
      ...
      if (currentpage-1)*MaxPerPage>totalput then 
       ...
       if currentPage=1 then 
           showpage totalput,MaxPerPage,"sjfk002.asp" 
            showContent 
            showpage totalput,MaxPerPage,"sjfk002.asp" 
       else 
          if (currentPage-1)*MaxPerPage<totalPut then 
...
%> 
            <table border="1" cellspacing="0" width="100%" bgcolor="#F6F6EC" style="border-collapse: collapse" cellpadding="0" height="68">
              ...
              <tr bgcolor="#7bb5de"> 
                ...
                <td align="center" style="border-bottom: 1px solid #C9D8AD" width="139" bgcolor="#D9E6FF"><b><a href="sjfk003.asp?lkid=<%=rs_serch("username")%>" style="text-decoration: none">电子卡确认</a></b></td>
...
</div> <p align="center"><b><a href="sjfk001.asp" style="text-decoration: none"><font color="#FF0000" size="6">返 回 搜 索</font></a></b></p>
</body> 
</html>