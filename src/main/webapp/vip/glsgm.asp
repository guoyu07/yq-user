...
if rs_my.eof and rs_my.bof or rs_my("sjb")=0 then
   ...
   response.write "alert('还不是双区会员，请检查输入是否正确或联系客服升级！');"
...
<DIV class=box_con style=" text-align:left">
	...
	<tr>
	<td align="center" width="34%"><p align="left"><span style="font-size: 11pt">当前用户名：<b><font color="#FF0000"><%=myup%></font></b></span></td>
	<td align="center"><p align="left"><span style="font-size: 11pt; font-weight:700"><font color="#008000"><a href="glsgm.asp?up=<%=downup%>"><font color="#000080">上层：<%=downup%></font></a></font></span></td>
	<td align="center" width="31%"><p align="left"><span style="font-size: 11pt; font-weight:700"><a href="glsgm.asp?up=<%=username%>"><font color="#008000">返回自己：<%=username%></font></a></span></td>
	</tr>
	</table>
	</td>
	</tr>
	...
	<td align="center" bgcolor="#C1F2C4" colspan="2"><b><font size="2">即将结算</font></b></td>
		...
		<tr>
			<td align="center" bgcolor="#FFFF97" height="26" width="159"><font color="#FF0000"><%=azaq%></font></td>
			<td align="center" bgcolor="#FFFF97" height="26" width="156"><font color="#FF0000"><%=azbq%></font></td>
			<td align="center" bgcolor="#FFDDBB" height="26" width="175"><font color="#FF0000"><%=aaq%></font></td>
			<td align="center" bgcolor="#FFDDBB" height="26" width="117"><font color="#FF0000"><%=abq%></font></td>
		</tr>
	</table>
		<p>　</div>
	<table border="0" width="90%" id="table1" height="241" cellspacing="5" cellpadding="3">
		<tr>
			...
			<td align="center" height="25">　</td>
			<td align="center" height="25">　</td>
			<td bgcolor="#DFDFDF" colspan="2" align="center" height="25"><b><font size="2"><%=myup%>(<%=rssjb%>)</font></b><font color="#008000" size="2"><font color="#000080">-(</font><font color="#FF0000"><%=downdqzuo%></font><font color="#000080">)-(</font><font color="#FF0000"><%=downdqyou%></font><font color="#000080">)</font></font></td>
			<td align="center" height="25">　</td>
			<td align="center" height="25">　</td>
			<td align="center" height="25">　</td>
		</tr>
		...
		<tr>
			...
			<td align="center" height="25">　</td>
			<td align="center" height="25">　</td>
			<td bgcolor="#B5FFFF" colspan="2" align="center" height="25"><font size="2"><%if rsbuid<>"" then%><a href="glsgm.asp?up=<%=rsbuid%>&my=<%=myid%>" style="text-decoration: none"><%=rsbuid%>（<%=rsbsjb%>）</a><%end if%></font></td>
			<td align="center" height="25">　</td>
		</tr>
		<tr>
			<td align="center" height="25">　</td>
		...
		<tr>
			<td bgcolor="#FFFFA4" colspan="2" align="center" height="25"><font size="2"><%if rs21auid<>"" then%><a href="glsgm.asp?up=<%=rs21auid%>&my=<%=myid%>" style="text-decoration: none"><%=rs21auid%>（<%=rs21asjb%>）</a><%end if%></font></td>
			<td bgcolor="#FFFFA4" colspan="2" align="center" height="25"><font size="2"><%if rs21buid<>"" then%><a href="glsgm.asp?up=<%=rs21buid%>&my=<%=myid%>" style="text-decoration: none"><%=rs21buid%>（<%=rs21bsjb%>）</a><%end if%></font></td>
			<td bgcolor="#FFFFA4" colspan="2" align="center" height="25"><font size="2"><%if rs22auid<>"" then%><a href="glsgm.asp?up=<%=rs22auid%>&my=<%=myid%>" style="text-decoration: none"><%=rs22auid%>（<%=rs22asjb%>）</a><%end if%></font></td>
			<td bgcolor="#FFFFA4" colspan="2" align="center" height="25"><font size="2"><%if rs22buid<>"" then%><a href="glsgm.asp?up=<%=rs22buid%>&my=<%=myid%>" style="text-decoration: none"><%=rs22buid%>（<%=rs22bsjb%>）</a><%end if%></font></td>
		</tr>
		<tr>
