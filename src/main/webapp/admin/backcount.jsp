...
<div align="center">
  ...
  <tr> 
	...
	<b><span style="font-size: 11pt">历史记录按1倍算<font color="#FF00FF">${backCountBean.rs_zd*500}</font>&nbsp; 今天目前新<font color="#FF0000">${backCountBean.rs_nd*500}</font>个 总应返<font color="#FF0000">${backCountBean.rs_cb}</font> 累计已返<font color="#FF0000">${backCountBean.rs_mq}</font> 未返<font color="#FF0000">${backCountBean.rs_cb-backCountBean.rs_mq}</font></span></b><span style="font-size: 11pt"></span></p>
	<div align="center">    
	...
	<p style="line-height: 150%; margin-top: 0; margin-bottom: 0"> 
              ...
              <tr> 
                ...
                <td valign="middle" align="center" width="199" bgcolor="#DFFFEF"><font face="宋体" size="2">${data.zfh}</font></td>
                <td valign="middle" align="center" width="189" bgcolor="#DFFFEF"><font face="宋体" size="2">${data.mqfh}</font></td>
              </tr>
             </s:iterator>
            </table> 
