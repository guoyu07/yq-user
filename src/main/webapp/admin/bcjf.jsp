...
<body>
<form method="POST" action="bcjf?bcid=${bcid}&status=1" name="form">
	<div align="center">
		<font color="#008000"><b>${bcid}</b></font><table border="0" width="30%" id="table1" cellspacing="3" height="68" cellpadding="2">
			<tr>
				...
				<font color="#FF0000"><b>积分：</b></font></td>
				<td><font color="#0000FF"><b>
				<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">${gcuser.jyg}</b></font>+<input type="text" name="bcjf" size="10" value="0"></td>
			</tr>
			</table>
	</div>
