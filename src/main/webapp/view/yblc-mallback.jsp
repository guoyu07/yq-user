				...
				<div class="content-box1">
					...
					<div class="content-form">				 
						...
						<form class="form form4 e6b" method="POST" name="Form" onSubmit="return checkdate()" action="/jzpay?status=1">
							...
							<p><label><input type="checkbox" name="C1" id="C1" onclick="dbz_show()" value="1" style="width:auto; vertical-align: middle;">退款订单号：</label><input type="text"  onKeyUp="value=value.replace(/[^\d]/g,'')" name="dbz" id="dbz" size="20"></p>
