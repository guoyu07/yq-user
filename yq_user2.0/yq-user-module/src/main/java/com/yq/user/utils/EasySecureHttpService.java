...
public class EasySecureHttpService {
	...
	private Map<String, EasySecureHttp> easySecureHttpMap = new HashMap<String, EasySecureHttp>();
	...
	public static void main(String[] args) {
		System.out.println(EasySecureHttpService.getInstance()
				.httpRequest("http://www.123123123.com", null, true));
	}
	...
	public static class EasySecureHttp {
		...
		private static ResultObject _request(String url, TreeMap<String, String> treeMap, String charset, boolean isPost) throws Exception{
			...
			try{
				String res = UrlRequestUtils.execute(url, treeMap, Mode.POST);
				return ResultObjectUtil.success(res);
			}catch(Exception e){
		...
		public ResultObject sendRenotify(String url, String data, String entrykey, boolean isPost) throws Exception{
			TreeMap<String, String> paramMap = new TreeMap<String, String>();
			paramMap.put(RSA_DATA_KEY, data);
			paramMap.put(RSA_APP_ID_KEY, merchantId);
			if(encryType.equals(ENCRY_TYPE_RSA) || encryType.equals(ENCRY_TYPE_MD5) || encryType.equals(ENCRY_TYPE_NONE)){
				if(encryType.equals(ENCRY_TYPE_RSA)){paramMap.put(RSA_ENCRY_KEY, entrykey);}
		...
		private String _buildSign4Rsa(TreeMap<String, String> treeMap,String privateKey) {
			...
			for (Map.Entry<String, String> entry : treeMap.entrySet()) {
				buffer.append(_formatStr(entry.getValue()));
			}
		...
		private String _buildSign4Md5(TreeMap<String, String> treeMap,String entryptKey) {
			...
			if (StringUtils.isNotEmpty(entryptKey)) {
				sign = MD5Security.md5_32_Small(signTemp);
			}
			return sign;
		}
	...
	public static class ResultObject implements Serializable {
		...
		public String toString(){
			...
			return bb.append("[code:").append(code)
	...
	static class ResultObjectUtil {
		
		public static ResultObject success() {
			return fire(0, "操作成功");
		}
		
		public static ResultObject success(Object obj) {
			return fire(0, "", obj);
		}

		public static ResultObject notLogin() {
			return fire(-1, "请先登录系统。");
		}

		public static ResultObject fire(int code, String msg, Object obj) {
			ResultObject ro = new ResultObject();
			ro.setCode(code);
			ro.setMsg(msg);
			ro.setData(obj);
			
			//LogServer.error(ResultObjectUtil.class, JSON.toJSONString(ro));
			return ro;
		}

		public static ResultObject fire(int code, String msg) {
			return fire(code, msg, "");
		}

		public static ResultObject fire(String msg) {
			return fire(1, msg);
		}

		public static String fire2Json(int code, String msg) {
			return JSON.toJSONString(fire(code, msg, ""));
			
		}

		public static String success2Json(Object obj) {
			return JSON.toJSONString(fire(0, "", obj));
		}
		
		public static String success2Json() {
			return JSON.toJSONString(fire(0, "恭喜你，操作成功！"));
		}
	}
