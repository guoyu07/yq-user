package com.yq.app.app.interceptor;
...
import com.yq.app.app.action.AppBaseActionSupport;
...
public class AppInterceptor extends BaseInterceptor {
	...
	public String intercept(ActionInvocation actionInvocation) throws Exception {
		...
		if (userName==null&&!className.equals("com.yq.app.app.action.AppNoAuthAction")) {
