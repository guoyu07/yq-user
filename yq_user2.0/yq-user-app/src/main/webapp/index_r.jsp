	...
	<div class="denglu">
		...
		<div class="d-login">
			<form method="POST" name="Form" onSubmit="return false">
				...
				<label style="position: absolute;top: 10px;left: 360px;isplay: inline-block;width: 280px;font-size: 18px;text-decoration: underline;"><a   href="/reg"><s:text  name='reg.jsp.reg.jsp.-1179328136'/></a></label><label style="position: absolute;top: 10px;left: 520px;isplay: inline-block;width: 280px;font-size: 18px;text-decoration: underline;"><a   href="/reg?lan=1"><s:text  name='Overseas.passport.registration'/></a></label>
			</form>
		</div>
		<div class="d-tips">
			<p>
