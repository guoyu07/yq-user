...
<form method="POST" action="" name="Form" id="Form" onSubmit="return false">
			  <font size="3">
			  <div align="center"><b><s:text name='viploginep.jsp.loginep.jsp.-2142554924'/></b><table border="0" width="75%" id="table1">
					<tr>
						<td><p align="left"><font size="2" ><s:text name="viploginep.jsp.loginep.jsp.2049228176"></s:text>。</font></td>
					</tr>
				</table>
				</div>
				<p align="center">
