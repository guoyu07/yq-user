...
<html>
<title><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.-69283997'/></title>
...
<DIV class=box_title><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.-69283997'/></DIV>
<DIV class=box>
<DIV class=box_con style=" text-align:left">

  <table border="0" cellspacing="0" width="100%" cellpadding="0" height="108">
    <tr>
      <td width="100%" height="25"><p align="center"><font color="#000000" size="3"><strong><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.-69283997'/></strong></font></td> 
  </tr> 
  <tr> 
...
<div align="center">    
          ...
          <td width="133" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000"> <strong style="font-weight: 400"><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.-1088521889'/></strong></font></td>
          <td width="152" align="center" height="28" bgcolor="#FFE1FF"><font color="#FF0000"><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.989905457'/></font></td>
          <td width="178" align="center" height="28" bgcolor="#FFE1FF"><font color="#000000"><s:text name='viewgrxx-gcbf.jsp.grxx-gcbf.jsp.811035898'/></font></td>
