							         ...
							         <s:iterator var="data" value="dataList">
								          <tr align="center" height="25"> 
										     ...
										     <c:otherwise>
									          ...
									          <td  width="238">
									          <c:choose>
									          	<c:when test="${userName==userName}"><a onClick="return confirm('<s:text name='canot_buy'/>!')" href="#"><font color="#FF0000" style="font-size: 11pt;text-decoration:line-through;"><s:text name="vipgpjymc.jsp.gpjymc.jsp.1526835300a"></s:text></font></a></c:when>
									          <c:otherwise>
