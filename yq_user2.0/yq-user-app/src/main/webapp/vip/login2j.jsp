...
<DIV class=mainnav>
	<DIV style="DISPLAY: none" class=Location>　</DIV></DIV></DIV>
<DIV class=box_title>
	<p align="right"><span style="font-weight: 400"><font color="#FFFFFF" size="1"></font></span></DIV>
<DIV class=box>
...
<form method="POST" action="" name="Form" id="Form" onSubmit="return false">
			  <font size="3">
			  <p align="center">
				<iframe name="I1" marginwidth="1" marginheight="1" height="245" border="0" frameborder="0" src="http://fuwu.zgyce.com/app/index.php?user=${userName}" align="center"></iframe>
				<p align="center"><s:text name='viplogin2j.jsp.login2j.jsp.-993576014'/>！</font><div align="center">
                  <table border="0" cellpadding="0" style="border:1px solid #008000; border-collapse: collapse" width="50%" id="AutoNumber4" height="112" bgcolor="#FFD7D7">
                    <tr>
                      ...
                      <font style="font-size: 11pt"><s:text name='viplogin2j.jsp.login2j.jsp.29623262'/>：</font></td>
                    ...
                    <tr> 
                      ...
                      <font style="font-size: 11pt"><s:text name='viplogin2j.jsp.login2j.jsp.630954966'/>：</font></td>
                      <td width="57%" height="40" align="left"> 
						<font size="3"> <span style="font-size: 11pt"><INPUT name="password3" size=12 type="password" ></span></font></td>
                    </tr>
                    <tr><td width="70%" height="40" align="center" colspan="2" bgcolor="#FFD7D7"> 
						<p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
						<font size="3"> 
                        <span style="font-size: 11pt"><input type="submit" value=" <s:text name='viplogin2j.jsp.login2j.jsp.941571312'/> " name="login" class="lkbtn" onClick="checkdate();"></span></font></td>
                    </tr>
                    </table>
                    </div>
                    </center>
