...
<table border="0" width="80%" id="table2" cellspacing="3" cellpadding="2" bgcolor="#E6FFF2">
		<tr>
			...
			<p style="line-height: 150%; margin-top: 0; margin-bottom: 0"><span style="font-size: 11pt"><s:text name='vipepmy.jsp.epmy.jsp.-1069342756'/>:<b><font color="#0000FF">${cz01}</font></b> </span><a target="_blank" href="https://wpa.qq.com/msgrd?v=3&uin=${qq}&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:${qq}:41" alt="<s:text name='viewservice.jsp.service.jsp.488997268'/>" title="<s:text name='viewservice.jsp.service.jsp.488997268'/>"></a></p>
