...
<div align="center">    
          <table border="1" cellspacing="0" width="100%" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0">
            <tr>
          <td width="148" align="center" height="28" bgcolor="#C3DAF9"><font  color="#000000" style="font-size: 11pt"><strong>用户名</strong></font></td>
          <td width="168" align="center" height="28" bgcolor="#C3DAF9"><p><font  color="#000000" style="font-size: 11pt; font-weight:700">QQ</font></td>
          <td width="202" align="center" height="28" bgcolor="#C3DAF9"><font color="#000000" style="font-size: 11pt; font-weight:700" >注册时间</font></td>
          <td width="116" align="center" height="28" bgcolor="#C3DAF9"><font color="#000000" style="font-size: 11pt; font-weight:700" >累计充值</font></td>
          <td width="217" align="center" height="28" bgcolor="#C3DAF9"><font color="#000000" style="font-size: 11pt; font-weight:700" >最近充值时间</font></td>
          <td width="148" align="center" height="28" bgcolor="#C3DAF9">双区玩家</td>
          <td width="228" align="center" height="28" bgcolor="#C3DAF9"><font ><span style="font-size: 11pt; font-weight:700">升级时间</span></font></td>
          </tr>
