...
<DIV class=daohang>
<DIV class=mainnav>
<DIV style="DISPLAY: none" class=Location><s:text name='viplogin3j.jsp.login3j.jsp.-1860602679'/></SPAN></DIV></DIV></DIV>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="90%" height="54%" id="AutoNumber1">
    <tr>
	  ...
	  <font size="3">
		...
		<b>
		<font size="5" color="#FF0000" face="楷体_GB2312"><s:text name='viplogin3j.jsp.login3j.jsp.-1886394640'/></font></b></p>
