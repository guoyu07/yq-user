...
<p><font style="font-size: 20pt; font-weight: 700" color="#800000"><s:text name='vipjztojb3.jsp.jztojb3.jsp.-1748044275'/></font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF">${gmsl*mj*1.5}<s:text name='viewzhgl-tmzhgl.jsp.zhgl-tmzhgl.jsp.643073'/></font><font style="font-size: 20pt; font-weight: 700" color="#800000"><s:text name='cash'/></font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF">=</font><font style="font-size: 20pt; font-weight: 700" color="#008000">${gmsl*mj/10}</font><font style="font-size: 20pt; font-weight: 700" color="#FF00FF"><s:text name='vipjztojb3.jsp.jztojb3.jsp.-1748044275a'/></font><font style="font-size: 20pt; font-weight: 700"><s:text name='viewyjcx-game.jsp.yjcx-game.jsp.1029202'/><s:text name='vipjztojb3.jsp.jztojb3.jsp.-1748044275b'/>${gmsl*mj}</font></p>
<p>　</p>
