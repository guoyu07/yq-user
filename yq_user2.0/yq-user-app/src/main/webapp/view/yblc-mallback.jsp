				...
				<div class="content-box1">
					...
					<div class="content-form new6-box">				 
						...
						<form class="form form4 e6b" method="POST" name="Form" onSubmit="return checkdate()" action="/glpay?status=1">
						    <p><label class="c-r"><s:text name='viewyblc-mallback.jsp.yblc-mallback.jsp.370420792'/>:</label><input type="text" name="fromUser" id="fromUser" size="15" maxlength="20" value="${userName}"><input type="button" onClick="Check(document.getElementById('fromUser').value)" value="<s:text name='viewyblc-mallback.jsp.yblc-mallback.jsp.370420792a'/>" name="B3" style="cursor: pointer"></p>
							<p><label class="c-r"><s:text name='viewyblc-mallback.jsp.yblc-mallback.jsp.-377971233'/>:</label><input type="text" name="jzuser" id="jzuser"  size="15" maxlength="20"><input type="button" onClick="Check(document.getElementById('jzuser').value)" value="<s:text name='viewyblc-mallback.jsp.yblc-mallback.jsp.370420792a'/>" name="B3" style="cursor: pointer"></p>
