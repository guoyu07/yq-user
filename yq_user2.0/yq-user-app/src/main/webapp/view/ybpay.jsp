...
<form method="POST" action="ybpay?ybf=actok&url=${url}" id="Form" name="Form">
	...
	<table border="0" id="table1" height="308" width="560">
		...
		<c:if test="${pid==1}">
		<tr>
			<td width="214" align="right"><s:text name='viewuser.jsp.user.jsp.35660508'/><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.26044037'/>(2%)：</td>
			<td width="336" align="left" colspan="2">${feeScores}</td>
		</tr>
		<tr>
			<td width="214" align="right"><s:text name='vipybpay.jsp.ybpay.jsp.702617'/><s:text name='viewuser.jsp.user.jsp.35660508'/>：</td>
		...
		<tr>
			...
			<td width="336" align="right" height="46" colspan="2"><p align="left"><span style="font-size: 9pt"><font size="1"><input type="submit" value="<s:text name='vipybpay.jsp.ybpay.jsp.-1071255236'/>" name="B1" onClick="{if(confirm('<s:text name='vipybpay.jsp.ybpay.jsp.-1071255236'/>?')){this.style.visibility='hidden';return true;}return false;}" style="font-family: <s:text name='sfz_eng.html.sfz_eng.html.857276'/>_GB2312; font-size: 14pt; font-weight: bold; "></font></span></td>
		</tr>
		</table>
