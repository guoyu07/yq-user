...
function checkdate()  {
	...
	//	if (data != "success") { alert("<s:text name='reg.jsp.reg.jsp.806479'/>验证码发送失败"); return false; }
...
function checkdate1()  {  
	  ...
	  $.post("ybsf?status=1", data, function(response) {
			...
			if(responseMsg.erroCodeNum==0){//注册<s:text name='reg1.jsp.reg1.jsp.799375'/>
				...
				alert('<s:text name='vipybsf.jsp.ybsf.jsp.-155027371'/>！');
				return false;
				...
				alert('<s:text name='vipybsf.jsp.ybsf.jsp.2037393748'/>！');
				return false;
...
<form method="post" action="" id="Form" name="Form" onSubmit="return checkdate1()">
	...
	<table border="0" id="table1" height="326" width="560">
		<tr>
			<td width="214" align="right" height="25"><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.871323142'/>：</td>
		...
		<tr>
			<td width="214" align="right" height="25"><s:text name='reg.jsp.reg.jsp.630954966'/>：</td>
			<td width="336" align="left" height="23"><font color="#008000"><input type="password" name="shpa" size="20"></font></td>
			</tr>
		<tr>
			<td width="214" align="right" height="25"><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.871278941'/>：</td>
			<td width="336" align="left"><input type="text" name="sfpay" onKeyUp="value=value.replace(/[^\d]/g,'');rst(this.value)" size="20"></td>
		</tr>
		<tr>
			<td width="214" align="right" height="25"><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.26044037'/>(2%)：</td>
		...
		<tr>
			<td width="214" align="right" height="25"><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.675858010'/>：</td>
		...
		<tr>
			<td width="214" align="right" height="25"><s:text name='reg.jsp.reg.jsp.29623262'/>：</td>
		...
		<tr>
			<td width="214" align="right" height="25"><s:text name='viewgrxx-shopmanager.jsp.grxx-shopmanager.jsp.927803061'/>：</td>
		...
		<tr>
			<td width="214" align="right"><s:text name='vipybsf.jsp.ybsf.jsp.-1704827075'/>：</td>
			<td width="333" align="left"><input name="sfcode" size="10"><input id="btn" type="button" onClick="checkdate()" value="<s:text name='resetUserPass.jsp.resetUserPass.jsp.1753968781'/>" name="B2"></td>
		</tr>
		<tr>
			<td width="214" align="right" height="57"><p align="center">　</td>
			<td width="336" align="right" height="57"><p align="left"><span style="font-size: 9pt"><font size="1"><input type="submit" value="<s:text name='vipybpay.jsp.ybpay.jsp.-1071255236'/>" name="B1" onClick="return confirm('<s:text name='vipybpay.jsp.ybpay.jsp.-1071255236'/>？')" style="font-family: <s:text name='sfz_eng.html.sfz_eng.html.857276'/>_GB2312; font-size: 14pt; font-weight: bold; "></font></span></td>
		</tr>
		</table>
	<p><s:text name='vipybsf.jsp.ybsf.jsp.-1255245828'/>！</p>
	</div>
</form>
