...
function checkdate()  {
  ...
  if (Form.newSecondPassword1.value == "") {		alert("请填入您的新二级密码不能为空!");	Form.newSecondPassword1.focus();		return false;}
  ...
  if (Form.newSecondPassword2.value == "") {		alert("确认二级密码不能为空!");Form.newSecondPassword1.focus();return false;}
