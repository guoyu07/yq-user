			...
			<div class="z-l">
				<div class="content-box1" style="height:190px;">
					<!--<div class="content-title">
						<span><s:text name='viewlogin2j.jsp.login2j.jsp.-993576014'/>！</span>
					</div>-->
...
<iframe name="I1" marginwidth="1" marginheight="1" height="100" border="0" frameborder="0" src="http://fuwu.zgyce.com/app/index.php?user=${userName}" align="center"></iframe>
				...
				<div class="content-box2 mth10" >
					<form class="form form4" method="POST" action="" name="Form" id="Form" onSubmit="return false">
							...
							<p><label></label><button class="but1" type="submit" value=" <s:text name='viplogin2j.jsp.login2j.jsp.941571312'/> " name="login" onClick="checkdate();"><s:text name="viploginjf.jsp.loginjf.jsp.665975448"></s:text></button></p>
					</form>
				</div>
			</div>
		</div>
