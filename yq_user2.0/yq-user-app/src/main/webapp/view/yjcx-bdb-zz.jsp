				...
				<div class="content-box1">
					...
					<div class="content-form">
						<form class="form form4 h463" method="POST" name="Form" onSubmit="return checkdate()" action="bdbzz?status=1">
							...
							<p><label><s:text name='viewyjcx-bdb-zz.jsp.yjcx-bdb-zz.jsp.1129373465'/>：</label>
							<select size="1" name="jzpay">
							...
							<font color="#008000" size="2"><s:text name='viewjflc-jfmc.jsp.jflc-jfmc.jsp.674320'/>：</font><b><font color="#0000FF" size="2">${sybdb}</font></b></p>
