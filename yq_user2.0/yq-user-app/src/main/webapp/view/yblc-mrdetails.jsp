	...
	<div class="mainbox mw1024">
		...
		<div class="center z-cb">
			...
			<div class="content z-l">
				<div class="content-box">
					<div class="content-title">
						<span><s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.-871299322'/></span>
					</div>
					<div class="content-table">
						<table>
							<tr>
								...
								<th><s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.21178581'/></th>
								<th><s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.625799226'/></th>
          ...
          <c:if test="${empty zftime}">
                ...
                <c:if test="${data.ep==2}">${data.dfuser}--<s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.-1073667942'/>。。。</c:if>
          </c:if></td>
          <td><a onClick="return confirm('<s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.-1689415574'/>？')" href="myepok?ep=${data.payid}"><font color="#FF0000" size="2">
            <c:if test="${data.ep==1}"><s:text name='viewyblc-mrdetails.jsp.yblc-mrdetails.jsp.314771621'/></c:if></font></a></td>
							</tr>
							</s:iterator>
						</table>
						<div class="page">
