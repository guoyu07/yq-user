			...
			<div class="z-l">
				<div class="content-box1">
					...
					<div class="content-form">
						<p><s:text name='vipmcsl.jsp.mcsl.jsp.227454429b'/>：<strong>${jydb}</strong> <s:text name='vipmcsl.jsp.mcsl.jsp.227454429a'/>：<strong><c:if test="${jygj<1}">${jygj}</c:if><c:if test="${jygj>=1}">${jygj}</c:if></strong></p>
