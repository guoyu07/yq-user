...
<div class="system">
					...
					<ul>
						...
						<li><a href="/login2j?inputUrl=login3j.jsp"><s:text name='viewzhgl-tmzhgl.jsp.zhgl-tmzhgl.jsp.643073'/><s:text name='viewjflc-jfmc.jsp.jflc-jfmc.jsp.682340'/></a>
						<%if(yblcGcuser.getVip()!=0){
							%><%="<b><a href='vipjzpay'>"%><s:text name='viewlinks.html.links.html.1159182'/><%="</a></b>"%>
						<%}%></li>
