			...
			<div class="z-l">
				...
				<div class="content-box2 mth10" >
					<form class="form form4" method="POST" action="" name="Form" id="Form" onSubmit="return false">
							...
							<p><label></label><button class="but1" type="submit" value=" <s:text name='viplogin2j.jsp.login2j.jsp.941571312'/> " name="login" onClick="checkdate();"><s:text name='viploginep.jsp.loginep.jsp.665975448'/></button></p>
					</form>
				</div>
			</div>
		</div>
