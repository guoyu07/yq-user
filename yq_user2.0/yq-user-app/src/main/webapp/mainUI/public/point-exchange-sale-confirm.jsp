...
<c:if test="${erroCodeNum==2000}"><script language=javascript>alert('卖出挂牌成功!');location.replace('gpjy?secondThisState=${secondThisState}&thisState=${thisState}');</script></c:if>
<!DOCTYPE html>
<html lang="zh-CN">
        ...
        <div class="widget-article">
          <form class="widget-form" method="POST" name="Form" onSubmit="return checkdate()" action="/mysl?status=1&secondThisState=${secondThisState}&thisState=${thisState}">
            ...
            <p class="button-line mt15">
              <a href="/mcsl?status=2&txpay=${txpay}&jygj=${jygj}&secondThisState=${secondThisState}&thisState=${thisState}" class="widget-button">确定无误</a>
            </p>
          </form>
