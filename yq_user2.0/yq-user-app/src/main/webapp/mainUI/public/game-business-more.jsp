          ...
          <div class="game-wrap fl ml20">
            ...
            <div class="game-table-content middle-size">
              <table class="current-distribution-status-6" border="0" cellspacing="0" cellpadding="0">
                <caption>(${myup})当前16层内层封情况</caption>
                <thead>
                  <tr>
                    <th>层数</th>
                    <th>左总</th>
