...
<head>
  <meta chartset="UTF-8">
  <title><s:text name='reg1.jsp.reg1.jsp.624662580'/>|<s:text name='Details_of_a_currency_change_details'/></title>
  ...
  <div class="member-main">
    <div class="dialog-widget">
      ...
      <p class="small-button-line">
        <a href="store-order-search.html" class="widget-warning mr10"><s:text name='mallorderquery'/></a>
