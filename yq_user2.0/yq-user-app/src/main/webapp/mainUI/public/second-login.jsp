      ...
      <div class="main-widget mt15">
        <form class="widget-form" method="POST" action="" name="Form" id="Form" onsubmit="return false">
          ...
          <p class="button-line mt15 tc">
            <button class="widget-button" type="submit" value="<s:text name='viplogin6j.jsp.login6j.jsp.941571312'/>" name="login" onclick="checkdate();"><s:text name='viploginmy.jsp.loginmy.jsp.665975448'/></button>
          </p>
        </form>
      </div>
      <!-- 二级密码登录验证 end -->
