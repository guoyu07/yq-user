...
<head>
  <meta chartset="UTF-8">
  <title><s:text name='viewlogin2j.jsp.login2j.jsp.624662580'/>|<s:text name='Coin_change_list_declaration'/>|<s:text name='declaration_coin_log'/> <s:text name='viewyblc-userscoreslog.jsp.yblc-userscoreslog.jsp.1135007'/></title>
...
<div class="member-dialog-container">
  <div class="member-main">
    <div class="dialog-widget">
      <p class="dialog-title"><s:text name='Coin_change_list_declaration'/>|<s:text name='declaration_coin_log'/> <s:text name='viewyblc-userscoreslog.jsp.yblc-userscoreslog.jsp.1135007'/></p>
      <!-- 图纸为一页13条数据 -->
