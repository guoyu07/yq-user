...
<head>
  <meta chartset="UTF-8">
  <title><s:text name='reg1.jsp.reg1.jsp.624662580'/>|<s:text name='viewgrxx.jsp.grxx.jsp.-1088456654'/></title>
...
<div class="container">
  <div class="member-content" id="J_memberContent">
    <div class="member-main-full">
      <!-- <s:text name='Bonus_points_change_details'/> -->
      <div class="main-widget">
        <p class="widget-title-line"><s:text name='Bonus_points_change_details'/></p>
...
<!-- 会员中心翻页组件 end -->
      ...
      <!-- <s:text name='Bonus_points_change_details'/> end -->
    </div>
  </div>
</div>
<!-- 账户管理内容 end -->
