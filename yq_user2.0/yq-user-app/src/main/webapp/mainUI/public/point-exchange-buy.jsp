...
<!-- 会员中心左边栏 end -->
    ...
    <div class="member-main">
      ...
      <div class="main-widget mt15">
        ...
        <p class="small-button-line"><a href="javascript:void(0);" class="widget-button-small JQ_moreDialog" data-url="point-exchange-sale-detail-more.html" id="J_rechargeDetailMore">查看更多</a></p>
