...
<script src="/scripts/jquery.datetimepicker.js"></script>
 ...
 function exportExcel(){
	 ...
	 var url="yibiservicerfeeExcel?startTime="+Form.startTime.value+"&endTime="+Form.endTime.value+"&searchUserName="+Form.searchUserName.value;//var url="vipcjbdetailsoutexcel?zuser="+Form.zuser.value+"&startDate1="+Form.startDate1.value+"&endDate1="+Form.endDate1.value;
...
<div align="center">
  ...
  <tr> 
	...
	<b><span style="font-size: 11pt">VIP(${searchUserName})(${gcuser.name})一币服务费明细表</span></b><span style="font-size: 11pt"></span></p>
	<p>
	<form method="post" name="Form" action="ybservicefee?status=1">
	...
	<input type="submit" value="查询"/><input type="button" onClick="exportExcel()" value="导出excel"/><br>
	</form>
	</p>
	...
	<div align="center">    
          ...
          <td width="123" align="center" height="29" bgcolor="#FFE1FF"><p style="margin-top: 0; margin-bottom: 0">
			<font face="宋体" color="#000000" size="2"><strong>用户名</strong></font></td>
			 ...
			 <font face="宋体" color="#000000" size="2"><strong>日期</strong></font></td>
			 <td width="67" align="center" height="29" bgcolor="#FFE1FF"><p style="margin-top: 0; margin-bottom: 0">
			<font color="#000000" face="宋体" size="2"> <strong>操作详情</strong></font></td>
			 <td width="67" align="center" height="29" bgcolor="#FFE1FF"><p style="margin-top: 0; margin-bottom: 0">
          ...
          <s:iterator var="data" value="vipserviceFeeList">
          <tr> 
		          <td height="29" width="123" align="center" bgcolor="#C3DAF9"><p style="margin-top: 0; margin-bottom: 0">
					...
					<font size="2" face="宋体">${data.date}</font></td>
					<td valign="middle" align="center" width="71" bgcolor="#C3DAF9"><p style="margin-top: 0; margin-bottom: 0">
					<font size="2" face="宋体">${data.desc}</font></td>
					<td valign="middle" align="center" width="71" bgcolor="#C3DAF9"><p style="margin-top: 0; margin-bottom: 0">
					<font size="2" face="宋体">${data.in}</font></td>
		          <td valign="middle" align="center" width="71" bgcolor="#C3DAF9"><p style="margin-top: 0; margin-bottom: 0">
					<font size="2" face="宋体">${data.servicefee}</font></td>
					<td valign="middle" align="center" width="71" bgcolor="#C3DAF9"><p style="margin-top: 0; margin-bottom: 0">
					<font size="2" face="宋体">${data.servicejine}</font></td>
		  </tr>	
