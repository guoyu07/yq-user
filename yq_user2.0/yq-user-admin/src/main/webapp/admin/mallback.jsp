		...
		<div id="DetailInfoContent">
			<table style="TABLE-LAYOUT: fixed; border-collapse:collapse" summary="宝贝描述" border="1" bordercolor="#006699" width="100%">
				<tr>
					...
					<p align="center">
					<span style="font-size: 11pt; font-weight: 700">商城退款</span></td>
				</tr>
				<tr>
					...
					<div class="content-form">				 
						...
						<form class="form form4 e6b" method="POST" name="Form" onSubmit="return checkdate()" action="glpay?status=1">
						    <p><label class="c-r">转出用户名：</label><input type="text" name="fromUser" id="fromUser" size="15" maxlength="20" value="${userName}"><input type="button" onClick="Check(document.getElementById('fromUser').value)" value="查看姓名" name="B3" style="cursor: pointer"></p>
							<p><label class="c-r">转入用户名：</label><input type="text" name="jzuser" id="jzuser"  size="15" maxlength="20"><input type="button" onClick="Check(document.getElementById('jzuser').value)" value="查看姓名" name="B3" style="cursor: pointer"></p>
